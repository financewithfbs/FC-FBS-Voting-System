...
export default function SignIn() {
  ...
  // Parallax pointer tracking (subtle) — desktop only
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* Base mesh gradient */}
        <div className="absolute inset-0 bg-[radial-gradient(120%_100%_at_0%_0%,#EDE7FF_0%,#F7F5FF_40%,#F7F5FF_100%)] dark:bg-[radial-gradient(120%_100%_at_0%_0%,#1a1238_0%,#0d0a1f_45%,#08061a_100%)]" />

        {/* Animated orbs */}
        <div className="absolute -top-48 -left-48 w-[40rem] h-[40rem] rounded-full bg-[#B09EE4]/50 dark:bg-[#6356D7]/25 blur-[120px] animate-float-slow" />
        <div className="absolute -bottom-56 -right-48 w-[44rem] h-[44rem] rounded-full bg-[#7E5FFF]/40 dark:bg-[#261753]/60 blur-[140px] animate-float-slower" />
        <div className="absolute top-1/3 left-1/2 w-72 h-72 rounded-full bg-[#6356D7]/20 dark:bg-[#7E5FFF]/15 blur-[100px] animate-float-slow" />
      ...
      {/* ───────── Form panel ───────── */}
      <div
        className={`relative z-20 w-full md:w-1/2 flex justify-center items-center px-6 sm:px-10 lg:px-16 order-2 md:order-1 md:h-full overflow-y-auto transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)] ${
          animatePanel
          ...
          <div className="relative rounded-3xl p-6 sm:p-8 bg-white/60 dark:bg-white/[0.03] backdrop-blur-2xl border border-white/70 dark:border-white/10 shadow-[0_20px_60px_-20px_rgba(99,86,215,0.25)] dark:shadow-[0_20px_60px_-20px_rgba(0,0,0,0.8)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" autoComplete="on">
              ...
              <div className="text-center md:text-left">
                <div className="inline-flex items-center gap-2 mb-3 px-3 py-1 rounded-full bg-[#6356D7]/10 dark:bg-[#6356D7]/25 border border-[#6356D7]/25 backdrop-blur-sm">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1.5">
                  ...
                  <button
                    type="button"
                    onClick={() => router.push("/auth/signup")}
                    className="relative text-[#6356D7] dark:text-[#b3a6ff] font-semibold hover:underline decoration-2 underline-offset-4"
                  >
                    Sign Up here.
                  </button>
                </p>
              ...
              <div className="relative">
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="peer w-full px-4 pt-6 pb-2 pr-12 border-2 border-[#6356D7]/15 dark:border-white/10 rounded-2xl text-sm bg-white/80 dark:bg-white/[0.03] backdrop-blur-sm text-gray-900 dark:text-gray-100 placeholder-transparent focus:outline-none focus:border-[#7E5FFF] focus:bg-white dark:focus:bg-white/[0.06] focus:shadow-[0_0_0_4px_rgba(126,95,255,0.15)] transition-all duration-300"
                />
                <label
                  className={`absolute left-4 transition-all duration-200 pointer-events-none ${
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#6356D7] dark:hover:text-[#9b8fff] transition-all duration-200 hover:scale-110"
              ...
              {/* Mobile sign-up link */}
              <div className="md:hidden text-center text-xs text-gray-600 dark:text-gray-400 pt-1">
                Don&apos;t have an account?{" "}
                <button
                  type="button"
                  onClick={() => router.push("/auth/signup")}
      ...
      {/* ───────── Illustration panel ───────── */}
      <div className="relative hidden md:flex md:w-1/2 items-center justify-center overflow-hidden order-1 md:order-2 md:h-full">
        {/* Layer 1: deep base */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a1040] via-[#0f0a28] to-[#0a0620]" />

        {/* Layer 2: color blobs */}
        <div className="absolute -top-32 -right-32 w-[28rem] h-[28rem] rounded-full bg-[#7E5FFF]/40 blur-[100px]" />
        <div className="absolute -bottom-40 -left-20 w-[26rem] h-[26rem] rounded-full bg-[#B09EE4]/30 blur-[100px]" />
        <div className="absolute top-1/3 left-1/4 w-64 h-64 rounded-full bg-[#5b3dff]/30 blur-[80px]" />
        ...
        <svg
          className="absolute left-0 top-0 h-full w-[140px] z-20 pointer-events-none"
          viewBox="0 0 140 800"
        ...
        >
          <defs>
            <linearGradient id="edgeGradSignin" x1="0" y1="0" x2="1" y2="0">
            ...
            <linearGradient id="edgeGlowSignin" x1="0" y1="0" x2="1" y2="0">
          ...
          <path
            d="M 140,0 C 30,220 30,580 140,800"
            fill="none"
            stroke="url(#edgeGradSignin)"
            strokeWidth="2"
          />
          <path
            d="M 140,0 C 45,220 45,580 140,800"
            fill="none"
            stroke="url(#edgeGlowSignin)"
            strokeWidth="1"
            strokeDasharray="2 6"
          />
        </svg>
        ...
        <div
          className="absolute top-[18%] left-[8%] z-30 animate-fade-up"
          style={{
            animationDelay: "0.4s",
        ...
        >
          <div className="flex items-center gap-2 px-3 py-2 rounded-2xl bg-white/[0.08] backdrop-blur-xl border border-white/15 shadow-[0_8px_30px_-8px_rgba(126,95,255,0.5)]">
            ...
            <div className="leading-tight">
              <p className="text-[10px] font-semibold text-white/60 uppercase tracking-wider">Secure</p>
              <p className="text-xs font-bold text-white">End-to-end encrypted</p>
            </div>
          </div>
        </div>

        <div
          className="absolute top-[42%] right-[8%] z-30 animate-fade-up"
          style={{
            animationDelay: "0.7s",
        ...
        >
          <div className="flex items-center gap-2 px-3 py-2 rounded-2xl bg-gradient-to-br from-[#7E5FFF]/30 to-[#5b3dff]/20 backdrop-blur-xl border border-white/15 shadow-[0_8px_30px_-8px_rgba(126,95,255,0.7)]">
            ...
            <div className="leading-tight">
              <p className="text-[10px] font-semibold text-white/60 uppercase tracking-wider">Live</p>
              <p className="text-xs font-bold text-white">Voting active</p>
            </div>
          </div>
        </div>

        <div
          className="absolute bottom-[16%] left-[14%] z-30 animate-fade-up"
          style={{
            animationDelay: "1s",
        ...
        >
          <div className="flex items-center gap-2 px-3 py-2 rounded-2xl bg-white/[0.08] backdrop-blur-xl border border-white/15 shadow-[0_8px_30px_-8px_rgba(176,158,228,0.5)]">
            <span className="text-lg">✓</span>
            <div className="leading-tight">
              <p className="text-[10px] font-semibold text-white/60 uppercase tracking-wider">Verified</p>
              <p className="text-xs font-bold text-white">FOSTIIMA members</p>
            </div>
          </div>
        </div>
        ...
        {/* Layer 8: logo */}
        <div className="absolute top-7 right-8 flex items-center gap-3 z-40 animate-fade-up" style={{ animationDelay: "0.2s" }}>
          <div className="relative">
        ...
        <div className="absolute top-1/3 left-8 w-1.5 h-1.5 bg-white/60 rounded-full animate-float-slow z-30 shadow-[0_0_12px_rgba(255,255,255,0.8)]" />
        <div className="absolute bottom-1/4 right-12 w-2 h-2 bg-[#B09EE4]/80 rounded-full animate-float-slower z-30 shadow-[0_0_16px_rgba(176,158,228,0.9)]" />
        <div className="absolute top-2/3 right-1/4 w-1 h-1 bg-white/70 rounded-full animate-float-slow z-30 shadow-[0_0_8px_rgba(255,255,255,0.9)]" />
        <div className="absolute top-1/5 right-1/5 w-1.5 h-1.5 bg-[#7E5FFF]/80 rounded-full animate-float-slower z-30 shadow-[0_0_12px_rgba(126,95,255,0.9)]" />
        <div className="absolute bottom-1/5 left-1/3 w-2 h-2 bg-white/50 rounded-full animate-float-slow z-30 shadow-[0_0_14px_rgba(255,255,255,0.7)]" />
      </div>
